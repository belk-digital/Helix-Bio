            ...
            <div className="prose prose-lg prose-headings:font-heading prose-headings:font-black prose-headings:tracking-tighter prose-headings:text-black prose-p:text-black/70 prose-p:leading-relaxed prose-li:text-black/70 prose-li:leading-relaxed prose-a:text-[#1e5661] hover:prose-a:text-[#84d0d9] max-w-none relative z-10">
              ...
              <div className="space-y-20">
                ...
                <section id="section3" className="scroll-mt-32">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-[15px] marker:text-[#1e5661]">
                ...
                <section id="section8" className="scroll-mt-32">
                  <h2 className="text-xl md:text-2xl uppercase mb-6 flex items-center gap-4">
                    <span className="text-black/20 font-mono text-lg font-bold">08.</span> 
                    {t('section8Title')}
                  </h2>
                  <p className="text-[15px] leading-relaxed">{t('section8Intro')}</p>
                  <ul className="list-disc pl-5 space-y-2 mt-4 text-[15px] marker:text-[#1e5661]">
                  ...
                  <div className="mt-6 p-5 bg-[#1e5661]/5 rounded-xl border-l-2 border-[#1e5661]">
                    <p className="m-0 font-medium text-black text-[15px]">{t('section8Note')}</p>
                  </div>
                </section>

                <section id="section9" className="scroll-mt-32">
                  <h2 className="text-xl md:text-2xl uppercase mb-6 flex items-center gap-4">
                    <span className="text-black/20 font-mono text-lg font-bold">09.</span> 
                    {t('section9Title')}
                  </h2>
                  <p className="text-[15px] leading-relaxed">{t('section9Intro')}</p>
                  <ul className="list-disc pl-5 space-y-2 mt-4 text-[15px] marker:text-[#1e5661]">
                ...
                <section id="section10" className="scroll-mt-32">
                  <h2 className="text-xl md:text-2xl uppercase mb-6 flex items-center gap-4">
                    <span className="text-black/20 font-mono text-lg font-bold">10.</span> 
                    {t('section10Title')}
                  </h2>
                  <p className="text-[15px] leading-relaxed">{t('section10Intro')}</p>
                  <ul className="list-disc pl-5 space-y-2 mt-4 text-[15px] marker:text-[#1e5661]">
                ...
                <section id="section11" className="scroll-mt-32">
                  <h2 className="text-xl md:text-2xl uppercase mb-6 flex items-center gap-4">
                    <span className="text-black/20 font-mono text-lg font-bold">11.</span> 
                    {t('section11Title')}
                  </h2>
                  <p className="text-[15px] leading-relaxed">{t('section11Text')}</p>
                </section>

                <section id="section12" className="scroll-mt-32">
                  <h2 className="text-xl md:text-2xl uppercase mb-6 flex items-center gap-4">
                    <span className="text-black/20 font-mono text-lg font-bold">12.</span> 
                    {t('section12Title')}
                  </h2>
                  <p className="text-[15px] leading-relaxed">{t('section12Text')}</p>
                </section>

                <section id="section13" className="scroll-mt-32">
                  <h2 className="text-xl md:text-2xl uppercase mb-6 flex items-center gap-4">
                    <span className="text-black/20 font-mono text-lg font-bold">13.</span> 
                    {t('section13Title')}
                  </h2>
                  <p className="text-[15px] leading-relaxed">{t('section13Text')}</p>
                </section>
